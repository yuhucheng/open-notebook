...
class PodcastSpeechScriptGenerationInput(CommandInput):
    episode_profile: str
    speaker_profile: str
    episode_name: str
...
@command("generate_podcast_speech_script", app="open_notebook")
async def generate_podcast_speech_script_command(
    input_data: PodcastSpeechScriptGenerationInput,
    ...
    try:
        ...
        episode = PodcastEpisode(
            ...
            briefing=briefing,
            content=input_data.speech_script_id,  # Store speech_script_id instead of content
            audio_file=None,
            transcript=None,
            outline=None,
        )
        ...
        # 6. Generate podcast using speech script
        logger.info("Starting speech script-based podcast generation...")

        result = await create_podcast_from_speech_script(
