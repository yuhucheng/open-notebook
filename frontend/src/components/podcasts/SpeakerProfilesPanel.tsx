  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg font-semibold">{t('podcasts.speakerProfiles')}</h2>
              ...
              <Card key={profile.id} className="shadow-sm">
                <CardHeader className="flex flex-col gap-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    >
                      {usageCount > 0
                        ? t('podcasts.usedBy', { count: usageCount })
                        : t('podcasts.unused')}
                    </Badge>
                  </div>
                </CardHeader>
                ...
                <CardContent className="space-y-4 text-sm">
                  ...
                  <div className="flex flex-wrap items-center justify-end gap-2">
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          <AlertDialogTitle>{t('podcasts.deleteSpeakerProfile')}</AlertDialogTitle>
                          <AlertDialogDescription>
                            {t('podcasts.deleteSpeakerProfileDesc', { name: profile.name })}
                          </AlertDialogDescription>
                          {deleteDisabled ? (
                            <p className="mt-2 text-sm text-muted-foreground">
                              {t('podcasts.removeSpeakerFirst')}
                            </p>
                          ) : null}
                        </AlertDialogHeader>
                        <AlertDialogFooter>
