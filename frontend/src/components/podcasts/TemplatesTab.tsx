  ...
  return (
    <div className="space-y-6">
      <div className="space-y-1">
        <h2 className="text-xl font-semibold">{t('podcasts.templatesWorkspace')}</h2>
        ...
        >
          <AccordionTrigger className="gap-2 py-4 text-left text-sm font-semibold">
            <div className="flex items-center gap-2">
              ...
              {t('podcasts.howTemplatesWork')}
            </div>
          </AccordionTrigger>
          <AccordionContent className="text-sm text-muted-foreground">
            <div className="space-y-4">
              <p className="text-muted-foreground/90">
                {t('podcasts.templatesDesc')}
              </p>

              <div className="space-y-2">
                <h4 className="font-medium text-foreground">{t('podcasts.episodeProfilesFormat')}</h4>
                <ul className="list-disc space-y-1 pl-5">
                  <li>{t('podcasts.episodeProfilesFormatDesc1')}</li>
                  <li>{t('podcasts.episodeProfilesFormatDesc2')}</li>
                  <li>{t('podcasts.episodeProfilesFormatDesc3')}</li>
                </ul>
              </div>

              <div className="space-y-2">
                <h4 className="font-medium text-foreground">{t('podcasts.speakerProfilesVoices')}</h4>
                <ul className="list-disc space-y-1 pl-5">
                  <li>{t('podcasts.speakerProfilesVoicesDesc1')}</li>
                  <li>{t('podcasts.speakerProfilesVoicesDesc2')}</li>
                  <li>{t('podcasts.speakerProfilesVoicesDesc3')}</li>
                </ul>
              </div>
              ...
              <div className="space-y-2">
                ...
                <ol className="list-decimal space-y-1 pl-5">
                  <li>{t('podcasts.recommendedWorkflowDesc1')}</li>
                  <li>{t('podcasts.recommendedWorkflowDesc2')}</li>
                  <li>{t('podcasts.recommendedWorkflowDesc3')}</li>
                </ol>
                <p className="text-xs text-muted-foreground/80">
                  {t('podcasts.recommendedWorkflowNote')}
                </p>
              </div>
            </div>
          </AccordionContent>
      ...
      {hasError ? (
        <Alert variant="destructive">
          ...
          <AlertTitle>{t('podcasts.loadTemplatesFailed')}</AlertTitle>
          <AlertDescription>
            {t('podcasts.loadTemplatesFailedDesc')}
          </AlertDescription>
        </Alert>
      ) : null}
