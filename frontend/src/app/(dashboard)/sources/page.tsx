...
export default function SourcesPage() {
  ...
  const fetchSources = useCallback(async (reset = false) => {
    try {
      ...
      toast.error(t('sources.loadFailed'))
    } finally {
      setLoading(false)
  ...
  return (
    <AppShell>
                ...
                >
                  ...
                  <td className="h-12 px-4 text-center hidden lg:table-cell">
                    <Badge variant={source.embedded ? "default" : "secondary"} className="text-xs">
                      {source.embedded ? t('common.yes') : t('common.no')}
                    </Badge>
                  </td>
                ...
                <tr>
                  <td colSpan={6} className="h-16 text-center">
                    <div className="flex items-center justify-center">
                      <LoadingSpinner />
                      <span className="ml-2 text-muted-foreground">{t('common.loadingMore')}</span>
                    </div>
                  </td>
                </tr>
              )}
      ...
      <ConfirmDialog
        ...
        description={t('sources.deleteDescription', { title: deleteDialog.source?.title || t('sources.untitled') })}
